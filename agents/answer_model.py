...
class AAgent(object):
    ...
    def generate_response(
        ...
        if system_prompt is None:
            ...
            system_prompt = ("You are an expert logical reasoning solver. ","Solve carefully and respond strictly in valid JSON.")
        ...
        with torch.inference_mode():
            generated_ids = self.model.generate(
                **model_inputs,
                max_new_tokens=kwargs.get("max_new_tokens", 128),  # reduce default
                pad_token_id=self.tokenizer.pad_token_id,
                do_sample=kwargs.get("do_sample", False),         # deterministic default
